...
#------------------------------------------------------------------------------#
#database = read_csv("./data/processed/ApolloData_nalt500_MNL_basic.csv")
database = readRDS("data/processed/ApolloData_nalt500_new.RDS")
...
model = apollo_estimate(apollo_beta, 
                        ...
                        apollo_inputs,
                        estimate_settings = list(silent = T))
return(model)
}
...
p
ggsave("output/inidividual_wtp.png", plot = p, height = 10, width = 8)
