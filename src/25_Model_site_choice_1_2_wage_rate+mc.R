...
# always
write.csv(df4,"data/processed/adjusted_cost_1_2_wagerate_mc.csv")
#-------------------------------------------------------------------------------
# import adjusted cost folder
df_adjusted_cost <- read.csv("data/processed/adjusted_cost_1_2_wagerate_mc.csv")
...
write_csv(df_apollo, "data/processed/ApolloData_nalt500_MNL_mc.csv")
