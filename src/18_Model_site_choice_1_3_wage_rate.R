...
# Title: model 5                                                               #
# Date: 9/29/2021                                                              #
# Description: Model site choice - include all birding hotspot - use wage rate #
# as 1/3 of the income                                                         #
################################################################################
...
# Travel costs
df_travel_costs <- read_csv("./data/processed/ab-ebd-travel-costs_1_3_wagerate.csv")
...
# always
write.csv(df4,"data/processed/adjusted_cost_1_3_wage.csv")
#------------------------------------------------------------------------------
# import adjusted cost folder - no need to run priceR always - save time
df_adjusted_cost <- read.csv("data/processed/adjusted_cost_1_3_wage.csv")
...
write_csv(df_apollo, "data/processed/ApolloData_nalt500_wagerate_1_3.csv")
