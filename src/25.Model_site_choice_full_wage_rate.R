...
# Travel costs
df_travel_costs <- read_csv("./data/processed/ab-ebd-travel-costs-marginal-half-wagerate.csv")
...
# always
write.csv(df4,"data/processed/adjusted_cost_full_wagerate_mc.csv")
#-------------------------------------------------------------------------------
# import adjusted cost folder
df_adjusted_cost <- read.csv("data/processed/adjusted_cost_full_wagerate_mc.csv")
...
write_csv(df_apollo, "data/processed/ApolloData_nalt500_MNL_basic_mc+full-wagerate.csv")
