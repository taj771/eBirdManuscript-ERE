...
#------------------------------------------------------------------------------#
database = read_csv("data/processed/ApolloData_nalt500_MNL_basic_mc+onethird-wagerate.csv")
...
#minimum = 1
deltaMethod(model, "(b_nrsr + (2*b_nrsr2*1) + (0.25*b_2nd_sr) + (0.25*b_3rd_sr) + (0.25*b_4th_sr))/ (-b_tc)")


#25th percentile = 39
deltaMethod(model, "(b_nrsr + (2*b_nrsr2*39) + (0.25*b_2nd_sr) + (0.25*b_3rd_sr) + (0.25*b_4th_sr))/ (-b_tc)")

#50th percentile = 72
deltaMethod(model, "(b_nrsr + (2*b_nrsr2*72) + (0.25*b_2nd_sr) + (0.25*b_3rd_sr) + (0.25*b_4th_sr))/ (-b_tc)")

#75th percentile = 112
deltaMethod(model, "(b_nrsr + (2*b_nrsr2*112) + (0.25*b_2nd_sr) + (0.25*b_3rd_sr) + (0.25*b_4th_sr))/ (-b_tc)")

#maximum = 257
deltaMethod(model, "(b_nrsr + (2*b_nrsr2*257) + (0.25*b_2nd_sr) + (0.25*b_3rd_sr) + (0.25*b_4th_sr))/ (-b_tc)")
